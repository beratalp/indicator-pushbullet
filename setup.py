...
DATA_FILES = [
	('/opt/extras.ubuntu.com/pushbullet-indicator/bin',glob.glob('bin/*')),
	('/opt/extras.ubuntu.com/pushbullet-indicator/share/pushbullet-indicator',['debian/changelog']),
	('/opt/extras.ubuntu.com/pushbullet-indicator/share/pushbullet-indicator',glob.glob('src/*.py')),
	('/opt/extras.ubuntu.com/pushbullet-indicator/share/pushbullet-indicator',['data/pushbullet-indicator-autostart.desktop']),	
	('/opt/extras.ubuntu.com/pushbullet-indicator/share/pushbullet-indicator/icons',glob.glob('data/icons/*.svg')),
	('/opt/extras.ubuntu.com/pushbullet-indicator/share/pushbullet-indicator/social',glob.glob('data/social/*.svg')),
	('/usr/share/applications',['data/extras-pushbullet-indicator.desktop']),		
	]
...
class install_data(_install_data):
	def run(self):
		for lang in os.listdir('build/locale-langpack/'):
			lang_dir = os.path.join('/opt/extras.ubuntu.com/pushbullet-indicator/share', 'locale-langpack', lang, 'LC_MESSAGES')
